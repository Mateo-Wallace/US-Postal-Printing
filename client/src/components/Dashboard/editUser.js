    ...
    <div>
      ...
      >
        ...
        <AccordionDetails>
          <form onSubmit={handleEditSubmit}>
            ...
            />
            <Button sx={{ ml: "15%" }} variant="contained" type="submit">
              Save
            </Button>
          </form>
        </AccordionDetails>
      ...
      >
        ...
        >
          ...
          <Typography>{userState.password || "###"}</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <form onSubmit={handleEditSubmit}>
            <TextField
      ...
      >
        ...
        >
          ...
          <Typography>{userState.phoneNum}</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <form onSubmit={handleEditSubmit}>
            <TextField
              ...
              onChange={(event) => {
                setUserState({ ...userState, phoneNum: event.target.value });
                setMessage(false);
              }}
            />
            <Button sx={{ ml: "15%" }} variant="contained" type="submit">
      ...
      <Button
        sx={{ mt: "10%", width: "100%", height: "50px" }}
        variant="contained"
        color="error"
        onClick={handleOpen}
      >
      ...
      >
        <Box sx={modalStyle}>
          ...
          >
            By clicking 'Confirm Deletion', you are deleting your current
            account and all associated information, which cannot be restored.
            After confirming, you will be logged out and redirected to the
            homepage.
          </Typography>
